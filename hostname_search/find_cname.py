...
output_dir    = '../../data/hostname_search/hostname/'
...
hostnames = list_data.load_data(hostname_dir + hostname_filename)
...
for hostname in hostnames:
  ...
  # try:
  #   this_cnames = get_cname1(hostname)
