...
###################
# if DEBUG2: print "\n========================="
# if DEBUG2: print "Copy Required Files"

# os.system("rm -rf %s" % (output_dir))
# os.system("python vxargs.py -a %s%s -o %s -t 30 scp -oBatchMode=yes -i ~/.ssh/planetlab_rsa -r ../../data/%s/hostname/keyword_list.txt %s@{}:~/%s/data/%s/hostname/" % (input_dir, deploy_node_filename, output_dir, taskname, username, projname, taskname))
...
###################
if DEBUG2: print "\n========================="
if DEBUG2: print "Check Alive Nodes again (2)"
